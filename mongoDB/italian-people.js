(function() {
  ...
  let randBlood = function() {
    let rhFactor = ["+", "-"];
    return (
      bloodType[Math.floor(Math.random() * bloodType.length)] +
      rhFactor[Math.floor(Math.random() * rhFactor.length)]
    );
  };
  ...
  let randjobs = function() {
    ...
    for (let i = 0; i < jobsNumber; i++)
      someoneJobs.push(jobs[Math.floor(Math.random() * jobs.length)]);
    return someoneJobs;
  };
  ...
  let randFruits = function() {
    ...
    for (let i = 0; i < fruitsNumber; i++)
      someoneFruits.push(fruits[Math.floor(Math.random() * fruits.length)]);
